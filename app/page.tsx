...
//   return (
//     <>
//       <div className={`bg-gradient-to-br ${theme === "dark" ? 'from-gray-900 via-blue-900 to-gray-900' : 'from-blue-50 via-blue-100 to-white'}  px-4 md:px-8 lg:px-16 py-12  transition- duration-300`}>
//         <Header />
//         <HeroSection />
