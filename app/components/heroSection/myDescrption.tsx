...
>
    {/* العنوان: شيلنا الـ <br /> عشان نخليهم جنب بعض */}
    <motion.h1
        variants={itemVariants}
    ...
    >
        Frontend {" "} {/* مسافة بسيطة بين الكلمتين */}
        <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-cyan-400">
            Developer
        </span>
    </motion.h1>

    {/* الوصف: عدلنا الـ margin والـ max-w */}
    <motion.p
        variants={itemVariants}
    ...
    {/* Badge الحالة الحالية: هييجي في النص تلقائياً بسبب items-center في الـ container */}
